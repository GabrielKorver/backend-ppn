    ...
    const planilhaDados = resultados.map((item) => {
      ...
      if (item.success && dados) {
        return {
          ...
          Status: item.success ? dados?.descStatusAtual || "---" : "Erro",
          "Erro (se houver)": item.success ? "" : item.error,
          ...
          "Número Destinatário": dados?.destinatario?.endereco?.numero || "---",
          "Complemento Destinatário":
            dados?.destinatario?.endereco?.complemento || "---",
          "Bairro Destinatário": dados?.destinatario?.endereco?.bairro || "---",
          "Cidade Destinatário": dados?.destinatario?.endereco?.cidade || "---",
          "UF Destinatário": dados?.destinatario?.endereco?.uf || "---",
          "CEP Destinatário": dados?.destinatario?.endereco?.cep || "---",
